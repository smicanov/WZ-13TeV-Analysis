...
Generic::Generic(Event* event, TFile* outputFile)
{
  fEvent = event;
...
TH1D*
Generic::bookTH1D(TString key, TString title, unsigned int nbins, double min, double max)
{
...
TH2D*
Generic::bookTH2D(TString key, TString title,
